...
var scrollVis = function scrollVis() {
  ...
  var setupVis = function setupVis() {
    ...
    polls2.forEach(function (d) {
      d3.tsv(d).then(function (data) {
        ...
        g.append("g").attr("class", "y axis " + classname).call(yAxis).style("opacity", 0).append("text").attr("transform", "rotate(-90)").attr("y", 6).attr("dy", ".71em").style("text-anchor", "end").text("Polling Percent");
        var candidate = g.selectAll(".candidates").data(candidates).enter().append("g").attr("class", "candidate " + classname).style("opacity", 0);
        ;
  ...
  function swing_2016() {
    ...
    g.selectAll(".fl_biden_sande").transition().duration(500).style("opacity", 0);
    g.selectAll(".fl_biden_trump").transition().duration(500).style("opacity", 0);
    g.selectAll(".fl_sanders_tru").transition().duration(500).style("opacity", 0);
  }
  ...
  function florida() {
    ...
    g.selectAll(".fl_biden_sande").transition().duration(500).style("opacity", 1);
    ...
    d3.select("#fl_biden_trump").on("click", function (d, i) {
      g.selectAll(".fl_biden_sande").transition().duration(500).style("opacity", 0);
      g.selectAll(".fl_biden_trump").transition().duration(500).style("opacity", 1);
      g.selectAll(".fl_sanders_tru").transition().duration(500).style("opacity", 0);
    });
    d3.select("#fl_sanders_trump").on("click", function (d, i) {
      g.selectAll(".fl_biden_sande").transition().duration(500).style("opacity", 0);
      g.selectAll(".fl_biden_trump").transition().duration(500).style("opacity", 0);
      g.selectAll(".fl_sanders_tru").transition().duration(500).style("opacity", 1);
    });
    g.selectAll(".ia_biden_sande").transition().duration(500).style("opacity", 0);
    g.selectAll(".ia_biden_trump").transition().duration(500).style("opacity", 0);
    g.selectAll(".ia_sanders_tru").transition().duration(500).style("opacity", 0);
  }
  ...
  function iowa() {
    ...
    g.selectAll(".fl_biden_trump").transition().duration(500).style("opacity", 0);
    g.selectAll(".fl_sanders_tru").transition().duration(500).style("opacity", 0);
    g.selectAll(".ia_biden_sande").transition().duration(500).style("opacity", 1);
    ...
    d3.select("#io_biden_trump").on("click", function (d, i) {
      g.selectAll(".ia_biden_sande").transition().duration(500).style("opacity", 0);
      g.selectAll(".ia_biden_trump").transition().duration(500).style("opacity", 1);
      g.selectAll(".ia_sanders_tru").transition().duration(500).style("opacity", 0);
    });
    d3.select("#io_sanders_trump").on("click", function (d, i) {
      g.selectAll(".ia_biden_sande").transition().duration(500).style("opacity", 0);
      g.selectAll(".ia_biden_trump").transition().duration(500).style("opacity", 0);
      g.selectAll(".ia_sanders_tru").transition().duration(500).style("opacity", 1);
    });
    g.selectAll(".mi_biden_sande").transition().duration(500).style("opacity", 0);
    g.selectAll(".mi_biden_trump").transition().duration(500).style("opacity", 0);
    g.selectAll(".mi_sanders_tru").transition().duration(500).style("opacity", 0);
  }
  ...
  function michigan() {
    ...
    g.selectAll(".ia_biden_trump").transition().duration(500).style("opacity", 0);
    g.selectAll(".ia_sanders_tru").transition().duration(500).style("opacity", 0);
    g.selectAll(".mi_biden_sande").transition().duration(500).style("opacity", 1);
    ...
    d3.select("#mi_biden_trump").on("click", function (d, i) {
      g.selectAll(".mi_biden_sande").transition().duration(500).style("opacity", 0);
      g.selectAll(".mi_biden_trump").transition().duration(500).style("opacity", 1);
      g.selectAll(".mi_sanders_tru").transition().duration(500).style("opacity", 0);
    });
    d3.select("#mi_sanders_trump").on("click", function (d, i) {
      g.selectAll(".mi_biden_sande").transition().duration(500).style("opacity", 0);
      g.selectAll(".mi_biden_trump").transition().duration(500).style("opacity", 0);
      g.selectAll(".mi_sanders_tru").transition().duration(500).style("opacity", 1);
    });
    g.selectAll(".oh_biden_sande").transition().duration(500).style("opacity", 0);
    g.selectAll(".oh_biden_trump").transition().duration(500).style("opacity", 0);
    g.selectAll(".oh_sanders_tru").transition().duration(500).style("opacity", 0);
  }
  ...
  function ohio() {
    ...
    g.selectAll(".mi_biden_trump").transition().duration(500).style("opacity", 0);
    g.selectAll(".mi_sanders_tru").transition().duration(500).style("opacity", 0);
    g.selectAll(".oh_biden_sande").transition().duration(500).style("opacity", 1);
    ...
    d3.select("#oh_biden_trump").on("click", function (d, i) {
      g.selectAll(".oh_biden_sande").transition().duration(500).style("opacity", 0);
      g.selectAll(".oh_biden_trump").transition().duration(500).style("opacity", 1);
      g.selectAll(".oh_sanders_tru").transition().duration(500).style("opacity", 0);
    });
    d3.select("#oh_sanders_trump").on("click", function (d, i) {
      g.selectAll(".oh_biden_sande").transition().duration(500).style("opacity", 0);
      g.selectAll(".oh_biden_trump").transition().duration(500).style("opacity", 0);
      g.selectAll(".oh_sanders_tru").transition().duration(500).style("opacity", 1);
    });
    g.selectAll(".pa_biden_sande").transition().duration(500).style("opacity", 0);
    g.selectAll(".pa_biden_trump").transition().duration(500).style("opacity", 0);
    g.selectAll(".pa_sanders_tru").transition().duration(500).style("opacity", 0);
  }
  ...
  function pennsylvania() {
    ...
    g.selectAll(".oh_biden_trump").transition().duration(500).style("opacity", 0);
    g.selectAll(".oh_sanders_tru").transition().duration(500).style("opacity", 0);
    g.selectAll(".pa_biden_sande").transition().duration(500).style("opacity", 1);
    ...
    d3.select("#pa_biden_trump").on("click", function (d, i) {
      g.selectAll(".pa_biden_sande").transition().duration(500).style("opacity", 0);
      g.selectAll(".pa_biden_trump").transition().duration(500).style("opacity", 1);
      g.selectAll(".pa_sanders_tru").transition().duration(500).style("opacity", 0);
    });
    d3.select("#pa_sanders_trump").on("click", function (d, i) {
      g.selectAll(".pa_biden_sande").transition().duration(500).style("opacity", 0);
      g.selectAll(".pa_biden_trump").transition().duration(500).style("opacity", 0);
      g.selectAll(".pa_sanders_tru").transition().duration(500).style("opacity", 1);
    });
    g.selectAll(".wi_biden_sande").transition().duration(500).style("opacity", 0);
    g.selectAll(".wi_biden_trump").transition().duration(500).style("opacity", 0);
    g.selectAll(".wi_sanders_tru").transition().duration(500).style("opacity", 0);
  }
  ...
  function wisconsin() {
    ...
    g.selectAll(".pa_biden_trump").transition().duration(500).style("opacity", 0);
    g.selectAll(".pa_sanders_tru").transition().duration(500).style("opacity", 0);
    g.selectAll(".wi_biden_sande").transition().duration(500).style("opacity", 1);
    ...
    d3.select("#wi_biden_trump").on("click", function (d, i) {
      g.selectAll(".wi_biden_sande").transition().duration(500).style("opacity", 0);
      g.selectAll(".wi_biden_trump").transition().duration(500).style("opacity", 1);
      g.selectAll(".wi_sanders_tru").transition().duration(500).style("opacity", 0);
    });
    d3.select("#wi_sanders_trump").on("click", function (d, i) {
      g.selectAll(".wi_biden_sande").transition().duration(500).style("opacity", 0);
      g.selectAll(".wi_biden_trump").transition().duration(500).style("opacity", 0);
      g.selectAll(".wi_sanders_tru").transition().duration(500).style("opacity", 1);
    });
  }
...
display();
},{"d3":"UzF0","topojson":"Ftz0","./FP_county_winners.csv":"lKn7","./FP_state_winners.csv":"ON0T","./FL_biden_v_trump.csv":"azxR","./FL_sanders_v_trump.csv":"RpCU","./IO_biden_v_trump.csv":"LITE","./IO_sanders_v_trump.csv":"cAn9","./MI_biden_v_trump.csv":"Nrv1","./MI_sanders_v_trump.csv":"dNFL","./OH_biden_v_trump.csv":"jd3x","./OH_sanders_v_trump.csv":"rCVe","./PA_biden_v_trump.csv":"U6SD","./PA_sanders_v_trump.csv":"R2CO","./WI_biden_v_trump.csv":"yKW1","./WI_sanders_v_trump.csv":"MxG4","./data/fl_biden_sanders.tsv":"nzMl","./data/fl_biden_trump.tsv":"RH4m","./data/fl_sanders_trump.tsv":"JlaN","./data/ia_biden_sanders.tsv":"bmV0","./data/ia_biden_trump.tsv":"eiJl","./data/ia_sanders_trump.tsv":"YYVI","./data/mi_biden_sanders.tsv":"xQQb","./data/mi_biden_trump.tsv":"E7IQ","./data/mi_sanders_trump.tsv":"VKGZ","./data/oh_biden_sanders.tsv":"DXXg","./data/oh_biden_trump.tsv":"GBbr","./data/oh_sanders_trump.tsv":"w2N7","./data/pa_biden_sanders.tsv":"Jqd0","./data/pa_biden_trump.tsv":"gHzm","./data/pa_sanders_trump.tsv":"QdSt","./data/wi_biden_sanders.tsv":"lPZt","./data/wi_biden_trump.tsv":"T8Dy","./data/wi_sanders_trump.tsv":"SvLl"}]},{},["Focm"], null)
//# sourceMappingURL=https://uw-cse442-wi20.github.io/FP-prediction-2020/src.4996d7a8.js.map