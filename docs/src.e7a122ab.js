...
var scrollVis = function scrollVis() {
  ...
  var yAxis = d3.axisLeft(y); // Define the color scale for the line graph
  ...
  var setupVis = function setupVis() {
    // title
    g.append("text").attr("class", "title").attr("x", width / 2).attr("y", height / 3).text("Prediction 2020").style("opacity", 0); // maps
    ...
    polls.forEach(function (d) {
      d3.tsv(d).then(function (data) {
        ...
        y.domain([5, d3.max(candidates, function (c) {
        ...
        mouseG.append('svg:rect').attr('width', width).attr('height', height).attr('fill', 'none').attr('pointer-events', 'all').on('mouseout', function () {
          ...
          d3.selectAll(".mouse-per-line").attr("transform", function (d, i) {
            ...
            while (true) {
              ...
              if (pos.x > mouse[0]) end = target;else if (pos.x < mouse[0]) beginning = target;else break;
            }
  ...
  function florida() {
    ...
    d3.select("#fl_sanders_trump").on("click", function (d, i) {
      g.selectAll(".fl_biden_sanders").transition().duration(500).style("opacity", 0);
      g.selectAll(".fl_biden_trump").transition().duration(500).style("opacity", 0);
      g.selectAll(".fl_sanders_trump").transition().duration(500).style("opacity", 1);
    });
    g.selectAll(".ia_biden_sanders").transition().duration(500).style("opacity", 0);
    g.selectAll(".ia_biden_trump").transition().duration(500).style("opacity", 0);
    g.selectAll(".ia_sanders_trump").transition().duration(500).style("opacity", 0);
  }
  ...
  function iowa() {
    ...
    g.selectAll(".fl_biden_trump").transition().duration(500).style("opacity", 0);
    g.selectAll(".fl_sanders_trump").transition().duration(500).style("opacity", 0);
    g.selectAll(".ia_biden_sanders").transition().duration(500).style("opacity", 1);
    ...
    d3.select("#io_sanders_trump").on("click", function (d, i) {
      g.selectAll(".ia_biden_sanders").transition().duration(500).style("opacity", 0);
      g.selectAll(".ia_biden_trump").transition().duration(500).style("opacity", 0);
      g.selectAll(".ia_sanders_trump").transition().duration(500).style("opacity", 1);
    });
    g.selectAll(".mi_biden_sanders").transition().duration(500).style("opacity", 0);
    g.selectAll(".mi_biden_trump").transition().duration(500).style("opacity", 0);
    g.selectAll(".mi_sanders_trump").transition().duration(500).style("opacity", 0);
  }
  ...
  function michigan() {
    ...
    g.selectAll(".ia_biden_trump").transition().duration(500).style("opacity", 0);
    g.selectAll(".ia_sanders_trump").transition().duration(500).style("opacity", 0);
    g.selectAll(".mi_biden_sanders").transition().duration(500).style("opacity", 1);
    ...
    d3.select("#mi_sanders_trump").on("click", function (d, i) {
      g.selectAll(".mi_biden_sanders").transition().duration(500).style("opacity", 0);
      g.selectAll(".mi_biden_trump").transition().duration(500).style("opacity", 0);
      g.selectAll(".mi_sanders_trump").transition().duration(500).style("opacity", 1);
    });
    g.selectAll(".oh_biden_sanders").transition().duration(500).style("opacity", 0);
    g.selectAll(".oh_biden_trump").transition().duration(500).style("opacity", 0);
    g.selectAll(".oh_sanders_trump").transition().duration(500).style("opacity", 0);
  }
  ...
  function ohio() {
    ...
    g.selectAll(".mi_biden_trump").transition().duration(500).style("opacity", 0);
    g.selectAll(".mi_sanders_trump").transition().duration(500).style("opacity", 0);
    g.selectAll(".oh_biden_sanders").transition().duration(500).style("opacity", 1);
    ...
    d3.select("#oh_sanders_trump").on("click", function (d, i) {
      g.selectAll(".oh_biden_sanders").transition().duration(500).style("opacity", 0);
      g.selectAll(".oh_biden_trump").transition().duration(500).style("opacity", 0);
      g.selectAll(".oh_sanders_trump").transition().duration(500).style("opacity", 1);
    });
    g.selectAll(".pa_biden_sanders").transition().duration(500).style("opacity", 0);
    g.selectAll(".pa_biden_trump").transition().duration(500).style("opacity", 0);
    g.selectAll(".pa_sanders_trump").transition().duration(500).style("opacity", 0);
  }
  ...
  function pennsylvania() {
    ...
    g.selectAll(".oh_biden_trump").transition().duration(500).style("opacity", 0);
    g.selectAll(".oh_sanders_trump").transition().duration(500).style("opacity", 0);
    g.selectAll(".pa_biden_sanders").transition().duration(500).style("opacity", 1);
    ...
    d3.select("#pa_sanders_trump").on("click", function (d, i) {
      g.selectAll(".pa_biden_sanders").transition().duration(500).style("opacity", 0);
      g.selectAll(".pa_biden_trump").transition().duration(500).style("opacity", 0);
      g.selectAll(".pa_sanders_trump").transition().duration(500).style("opacity", 1);
    });
  ...
  function wisconsin() {
    ...
    g.selectAll(".pa_biden_trump").transition().duration(500).style("opacity", 0);
    g.selectAll(".pa_sanders_trump").transition().duration(500).style("opacity", 0);
    g.selectAll(".wi_biden_sanders").transition().duration(500).style("opacity", 1);
  ...
  function clicked(d) {
    ...
    active = d3.select(this).classed("active", true); //			.attr("display", "none");
...
//# sourceMappingURL=https://uw-cse442-wi20.github.io/FP-prediction-2020/src.e7a122ab.js.map